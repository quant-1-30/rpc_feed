...
if __name__ == "__main__":
   ...
   # struct
   #  dataset_path = os.path.join(os.path.expanduser("~"), "Downloads/quant/data/struct/202506") # tick
   #  xml = "../xml/tick.graphml"
   #  bt_feed.load(xml, dataset_path, prefix=".01", _filter="asset")
    
    dataset_path = os.path.join(os.path.expanduser("~"), "Downloads/quant/data/struct/202506") # fund
